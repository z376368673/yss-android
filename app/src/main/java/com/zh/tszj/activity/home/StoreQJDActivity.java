 ...
 * 旗舰店
 */
public class StoreQJDActivity extends BaseActivity implements OnRefreshLoadMoreListener {
     ...
     * 旗舰店铺
     */
    protected void vipShops() {
        Call<ResponseBody> call = HttpClient.getApi(API.class).vipShops(curr, limit);
