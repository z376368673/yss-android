...
public class UDialog extends Dialog {
    ...
    public UDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public UDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
     ...
     */
    public UDialog(Context context, float alpha, int gravity) {
        super(context);
