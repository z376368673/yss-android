...
public class UImageView extends AppCompatImageView {
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.UImageView, defStyleAttr, 0);
        currMode = a.hasValue(R.styleable.UImageView_type) ? a.getInt(R.styleable.UImageView_type, MODE_NONE) : MODE_NONE;
        currRound = a.hasValue(R.styleable.UImageView_radius) ? a.getDimensionPixelSize(R.styleable.UImageView_radius, currRound) : currRound;
        a.recycle();
    }
