package com.android.baselib.scaner;
...
import com.android.baselib.scaner.decoding.InactivityTimer;
import com.android.baselib.scaner.tools.RxBeepTool;
...
//         mCropLayout.measure(0,0);
//         int heiht   =  mCropLayout.getMeasuredHeight()-10;
//        ObjectAnimator animation = new ObjectAnimator().ofFloat(view,"translationY",0,heiht);
//        ScaleAnimation animation = new ScaleAnimation(1.0f, 1.0f, 0.0f, 1.0f);
        TranslateAnimation animation = new TranslateAnimation(1.0f, 1.0f, 0.0f,  UScreenUtil.dp2px(270));
...
//            mIvLight.setImageResource(R.mipmap.ic_scan_open);
        } else {
            mFlashing = true;
            // 关闪光灯
            CameraManager.get().offLight();
//            mIvLight.setImageResource(R.mipmap.ic_scan_close);
        }
...
//            int cropHeight = mCropLayout.getHeight() * height.get() / mContainer.getHeight();
            ...
            int cropWidth = outMetrics.widthPixels;
            int cropHeight = outMetrics.heightPixels;
...
//                } else {
//                    if (mScanerListener == null) {
//                        Log.e(TAG, "onActivityResult: 图片识别失败");
